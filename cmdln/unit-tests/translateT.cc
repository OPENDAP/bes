...
CPPUNIT_TEST_SUITE( translateT );
    ...
    void do_test()
    {
        ...
        try {
            ...
            doc = CmdTranslation::translate(
                "define d as c with c.constraint=\"u\",c.attributes=\"u\" aggregate using agg by \"u\";");
            cout << doc << endl;
...
int main(int argc, char *argv[])
{
    ...
    while ((option_char = getopt(argc, argv, "dh")) != -1)
        ...
        case 'h': {     // help - show test names
            ...
            unsigned int prefix_len = translateT::suite()->getName().append("::").size();
