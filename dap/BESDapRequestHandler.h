...
#ifndef I_BESDapRequestHandler_H
#define I_BESDapRequestHandler_H 1

#include "BESRequestHandler.h"

class BESDapRequestHandler : public BESRequestHandler
{
public:
			BESDapRequestHandler( const std::string &name ) ;
