 ...
 */
void
BESXMLDeleteContainerCommand::parse_request( xmlNode *node )
{
    string name ;
    string value ;
 ...
 */
void
BESXMLDeleteContainerCommand::dump( ostream &strm ) const
{
    strm << BESIndent::LMarg << "BESXMLDeleteContainerCommand::dump - ("
			     << (void *)this << ")" << endl ;
    BESIndent::Indent() ;
