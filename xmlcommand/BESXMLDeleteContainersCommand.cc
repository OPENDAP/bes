 ...
 */
void
BESXMLDeleteContainersCommand::parse_request( xmlNode *node )
{
    string name ;
    string value ;
    ...
    _dhi.action = DELETE_CONTAINERS ;

    _str_cmd = (string)"delete containers from " + storage + ";" ;
 ...
 */
void
BESXMLDeleteContainersCommand::dump( ostream &strm ) const
{
    strm << BESIndent::LMarg << "BESXMLDeleteContainersCommand::dump - ("
			     << (void *)this << ")" << endl ;
    BESIndent::Indent() ;
