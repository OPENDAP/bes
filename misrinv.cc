// The code in this file is adopted from A.7.2 of MISR data products specifications 
// // Revision S
// // https://eosweb.larc.nasa.gov/sites/default/files/project/misr/DPS_v50_RevS.pdf)
//
