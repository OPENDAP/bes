...
// 02874-0112.
#ifndef E_OPENDAP_CLASSResponseNames_H
#define E_OPENDAP_CLASSResponseNames_H 1

#define OPENDAP_CLASS_NAME "OPENDAP_TYPE"

#endif // E_OPENDAP_CLASSResponseNames_H
