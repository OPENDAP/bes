 ...
 */
CmrContainerStorage::CmrContainerStorage(const string &n) :
        BESContainerStorageVolatile(n)
{
}

CmrContainerStorage::~CmrContainerStorage()
{
}
 ...
 */
void CmrContainerStorage::add_container(const string &s_name, const string &r_name, const string &type)
{
    BESContainer *c = new CmrContainer(s_name, r_name, type);
 ...
 */
void CmrContainerStorage::dump(ostream &strm) const
{
