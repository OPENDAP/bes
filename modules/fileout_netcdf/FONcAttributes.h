...
private:
    ...
    static void	add_dap4_attributes_worker( int ncid, int varid, const string &var_name, D4Attributes *d4_attrs, D4Attribute *attr, const string &prepend_attri,bool is_netCDF_enhanced ) ;
public:
