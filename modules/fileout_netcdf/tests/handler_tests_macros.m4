...
m4_define([_AT_BESCMD_TEST_NC4_ENHANCED], [dnl
...
m4_define([_AT_BESCMD_BINARYDATA_TEST_NC4_ENHANCED],  [dnl
...
m4_define([_AT_BESCMD_DAP4_BINARYDATA_TEST_NC4_ENHANCED],  [dnl
...
m4_define([_AT_BESCMD_NETCDF_TEST_NC4_ENHANCED],  [dnl
...
dnl Add NC4 enhanced macro 
m4_define([AT_BESCMD_RESPONSE_TEST_NC4_ENHANCED],
[_AT_BESCMD_TEST_NC4_ENHANCED([$abs_srcdir/$1], [$abs_srcdir/$1.baseline], [$2])
])

m4_define([AT_BESCMD_REPEAT_RESPONSE_TEST_NC4_ENHANCED],
[_AT_BESCMD_TEST_NC4_ENHANCED([$abs_srcdir/$1], [$abs_srcdir/$1.baseline], [$2], [$3])
])

m4_define([AT_BESCMD_BINARYDATA_RESPONSE_TEST_NC4_ENHANCED],
[_AT_BESCMD_BINARYDATA_TEST_NC4_ENHANCED([$abs_srcdir/$1], [$abs_srcdir/$1.baseline], [$2])])

m4_define([AT_BESCMD_BINARY_DAP4_RESPONSE_TEST_NC4_ENHANCED],
[_AT_BESCMD_DAP4_BINARYDATA_TEST_NC4_ENHANCED([$abs_srcdir/$1], [$abs_srcdir/$1.baseline], [$2])])

m4_define([AT_BESCMD_NETCDF_RESPONSE_TEST_NC4_ENHANCED],
[_AT_BESCMD_NETCDF_TEST_NC4_ENHANCED([$abs_srcdir/$1], [$abs_srcdir/$1.baseline], [$2])])
