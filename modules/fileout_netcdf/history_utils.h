...
// NEW
void updateHistoryAttribute(DMR *dmr, const std::string &ce);

void update_cf_history_attr(D4Attribute *global_attribute, const std::string &request_url);
void update_history_json_attr(D4Attribute *global_attribute, const std::string &request_url);
