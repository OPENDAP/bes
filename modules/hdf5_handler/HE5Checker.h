...
class HE5Checker {
 public:
    ...
    bool check_grids_missing_projcode(HE5Parser*p) const;
    bool check_grids_unknown_parameters(HE5Parser* p) const;
    bool check_grids_support_projcode(HE5Parser*p) const;
