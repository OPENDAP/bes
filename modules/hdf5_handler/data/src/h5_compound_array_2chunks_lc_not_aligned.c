...
//#define H5FILE_NAME   "compound_low_comp_two_chunks_naligned_lc.h5"
#define H5FILE_NAME   "compound_two_chunks_naligned_lc.h5"
 ...
 *           */
    ...
    H5Pset_chunk(plist_id,1,array_dimc);
#if 0
