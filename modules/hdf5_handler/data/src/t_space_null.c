/*
  ...
  %/path/to/hdf5/bin/h5cc -o t_space_null t_space_null.c 

  To generate the test file, run
  %./t_space_null

  To view the test file, run
  %/path/to/hdf5/bin/h5dump t_space_null.h5
...
#define H5FILE_NAME "t_space_null.h5"
...
main (void)
{
    ...
    /*
     * Write the data although it has no effect because dataspace is NULL.
     */
