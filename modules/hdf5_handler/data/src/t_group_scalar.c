...
#define H5FILE_NAME "t_group_scalar.h5"
...
//#if 0
    ...
    dset = H5Dcreate2(file, "string", filetype, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, memtype, H5S_ALL, H5S_ALL, H5P_DEFAULT, wdata10);
    attr = H5Acreate2(dset, "string", filetype, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, memtype, wdata10);
    H5Dclose(dset);
    H5Aclose(attr);


    dset = H5Dcreate2(grp, "gstring", filetype, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, memtype, H5S_ALL, H5S_ALL, H5P_DEFAULT, wdata10);
    attr = H5Acreate2(dset, "gstring", filetype, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, memtype, wdata10);
    H5Dclose(dset);
    H5Aclose(attr);
...
//#endif
    ...
    dset = H5Dcreate2(grp, "uint16", H5T_NATIVE_USHORT, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_USHORT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata8);
    attr = H5Acreate2(dset, "uint16", H5T_NATIVE_USHORT, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_USHORT, &wdata8);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "uint32", H5T_NATIVE_UINT, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_UINT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata9);
    attr = H5Acreate2(dset, "uint32", H5T_NATIVE_UINT, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_UINT, &wdata9);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "float", H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_FLOAT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata6);
    attr = H5Acreate2(dset, "float", H5T_NATIVE_FLOAT, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_FLOAT, &wdata6);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "double", H5T_NATIVE_DOUBLE, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_DOUBLE, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata7);
    attr = H5Acreate2(dset, "double", H5T_NATIVE_DOUBLE, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_DOUBLE, &wdata7);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "char", H5T_NATIVE_CHAR, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_CHAR, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata);
    attr = H5Acreate2(dset, "char", H5T_NATIVE_CHAR, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_CHAR, &wdata);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    H5Aclose(attr);
    dset = H5Dcreate2(grp, "signed_char", H5T_NATIVE_SCHAR, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_SCHAR, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata2);
    attr = H5Acreate2(dset, "signed_char", H5T_NATIVE_SCHAR, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_SCHAR, &wdata2);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "unsigned_char", H5T_NATIVE_SCHAR, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_SCHAR, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata3);
    attr = H5Acreate2(dset, "unsigned_char", H5T_NATIVE_SCHAR, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_SCHAR, &wdata3);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "int16", H5T_NATIVE_SHORT, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_SHORT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata4);
    attr = H5Acreate2(dset, "int16", H5T_NATIVE_SHORT, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_SHORT, &wdata4);
    H5Dclose(dset);
    H5Aclose(attr);
    ...
    dset = H5Dcreate2(grp, "int32", H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT,H5P_DEFAULT);
    status = H5Dwrite(dset, H5T_NATIVE_INT, H5S_ALL, H5S_ALL, H5P_DEFAULT, &wdata5);
    attr = H5Acreate2(dset, "int32", H5T_NATIVE_INT, sid, H5P_DEFAULT, H5P_DEFAULT);
    status  = H5Awrite(attr, H5T_NATIVE_INT, &wdata5);
    H5Dclose(dset);
    H5Aclose(attr);
