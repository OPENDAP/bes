...
class HDF5GMCFMissLLArray:public HDF5BaseArray {
    ...
    void obtain_aqu_obpg_l3_ll(const int* offset,const int* step,int nelms,bool add_cache, void*buf);

    void obtain_gpm_l3_ll(const int* offset,const int* step,int nelms,bool add_cache, void*buf);
