...
main (int argc, char **argv)
{
    ...
    if(strcmp(argv[1],"-k") == 0) 
        ...
        dset2 = H5Dcreate2 (file, DATASET2, filetype2, space2, H5P_DEFAULT, dcpl, H5P_DEFAULT); 
    dset3 = H5Dcreate2 (file, DATASET3, filetype, space3, H5P_DEFAULT, dcpl2, H5P_DEFAULT);
    dset4 = H5Dcreate2 (file, DATASET4, filetype3, space4, H5P_DEFAULT, dcpl3, H5P_DEFAULT);
