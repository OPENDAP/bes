...
private:
    ...
    /// error (e.g. InternalError, SlowDown) instead of chunk data. Recorded here
...
public:
    ...
    /// place of throwing, so libcurl's normal CURLE_WRITE_ERROR retry path (already used
    /// today for things like CURLE_GOT_NOTHING) gets a chance to retry this request.
