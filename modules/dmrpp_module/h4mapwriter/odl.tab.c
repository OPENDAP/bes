...
#define yyparse         odlparse
#define yylex           odllex
#define yyerror         odlerror
#define yylval          odllval
#define yychar          odlchar
#define yydebug         odldebug
#define yynerrs         odlnerrs
...
/* In a future release of Bison, this section will be replaced
   by #include "odl.tab.h".  */
#ifndef YY_ODL_ODL_TAB_H_INCLUDED
# define YY_ODL_ODL_TAB_H_INCLUDED
/* Enabling traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
...
extern YYSTYPE odllval;

#ifdef YYPARSE_PARAM
#if defined __STDC__ || defined __cplusplus
int odlparse (void *YYPARSE_PARAM);
#else
int odlparse ();
#endif
#else /* ! YYPARSE_PARAM */
#if defined __STDC__ || defined __cplusplus
int odlparse (FILE *arg);
#else
int odlparse ();
#endif
#endif /* ! YYPARSE_PARAM */

#endif /* !YY_ODL_ODL_TAB_H_INCLUDED  */
...
{
       0,    73,    73,    73,    76,    80,    84,    79,    92,    95,
      91,   102,   101,   109,   113,   119,   120,   121,   124,   125,
     126,   134,   160,   164,   170,   177,   185,   193,   201,   217,
     233,   237,   243,   250
};
#endif
...
static const char *const yytname[] =
{
  ...
  "floatints", "float_or_int", "strs", YY_NULL
};
#endif
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, FILE *arg)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, FILE *arg)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, FILE *arg)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, FILE *arg)
#else
static void
...
#line 135 "odl.y"
    ...
    if (data_type == DFNT_CHAR) {
        write_array_attribute(arg, DFNT_CHAR, strlen((yyvsp[(2) - (3)]))-1, (yyvsp[(2) - (3)]), 
                              strlen((yyvsp[(2) - (3)]))-1, -1, -1,
                              indent+1);
    }
...
#line 202 "odl.y"
    {
                    ...
                    if (buf == NULL) {
                        if (data_type == DFNT_FLOAT32) {
                            ...
                            ((float32 *)buf)[0] = atof((yyvsp[(1) - (1)]));
                        }
                        else {
                            buf = (int32 *) HDmalloc(sizeof(int32));
                            ((int32 *)buf)[0] = atoi((yyvsp[(1) - (1)]));
                        }
...
#line 218 "odl.y"
    {
                    ...
                    if(data_type == DFNT_FLOAT32) {
                        ...
                        ((float32 *)buf)[list_count-1] = atof((yyvsp[(3) - (3)]));
                    }
                    else {
                        buf = (int32 *) HDrealloc((VOIDP) buf,
                                                    list_count * sizeof(int32));
                        ((int32 *)buf)[list_count-1] = atoi((yyvsp[(3) - (3)]));                        
                    }
		}
    break;
...
#line 244 "odl.y"
    {
                    strval = (char*) HDmalloc(strlen((yyvsp[(1) - (1)]))+1);
                    strncpy(strval, (yyvsp[(1) - (1)]), strlen((yyvsp[(1) - (1)])));
                    strval[strlen((yyvsp[(1) - (1)]))] = '\0';
