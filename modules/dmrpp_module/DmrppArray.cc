...
void process_super_chunk_unconstrained(const shared_ptr<SuperChunk>& super_chunk, DmrppArray *array)
{
    ...
    const vector<unsigned long long> array_shape = array->get_shape(true);
    // The size, in elements, of each of the chunk's dimensions
    const vector<unsigned long long> chunk_shape = array->get_chunk_dimension_sizes();
...
void process_one_chunk_unconstrained(shared_ptr<Chunk> chunk, DmrppArray *array, const vector<unsigned long long> &array_shape,
...
void process_super_chunk(const shared_ptr<SuperChunk>& super_chunk, DmrppArray *array)
{
    ...
    vector<unsigned long long> constrained_array_shape = array->get_shape(true);
