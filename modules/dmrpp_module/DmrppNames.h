...
#if 0
#define DMRPP_USE_FLOAT_OPT_IN_FONC "FONc.FloatWriteOpt"
#define DMRPP_FLOAT_BUFFER_SIZE_IN_FONC "FONC_FLOAT_WRITE_OPT_BUFFER_SIZE"
#define DMRPP_FLOAT_COMP_RATIO_IN_FONC "FONC_FLOAT_WRITE_OPT_COMP_RATIO"
#endif 
