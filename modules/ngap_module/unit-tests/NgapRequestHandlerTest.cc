...
public:
    ...
    void test_compiled_default_cache_keys() {
        ...
        CPPUNIT_ASSERT_MESSAGE("Expected the CMR cache space to be 20", NgapRequestHandler::d_cmr_cache_space == 20);
        CPPUNIT_ASSERT_MESSAGE("Expected the DMR++ cache space to be 20", NgapRequestHandler::d_dmrpp_cache_space == 20);
    }
    ...
    void test_custom_cache_params() {
        ...
        TheBESKeys::TheKeys()->set_key("NGAP.CMRCacheThreshold", "17");
        TheBESKeys::TheKeys()->set_key("NGAP.CMRCacheSpace", "7");

        TheBESKeys::TheKeys()->set_key("NGAP.DMRppCacheThreshold", "17");
        TheBESKeys::TheKeys()->set_key("NGAP.DMRppCacheSpace", "7");
        ...
        // These will still have the default values
        CPPUNIT_ASSERT_MESSAGE("Expected the CMR cache threshold to be 100", NgapRequestHandler::d_cmr_cache_threshold == 17);
        CPPUNIT_ASSERT_MESSAGE("Expected the DMR++ cache threshold to be 100", NgapRequestHandler::d_dmrpp_cache_threshold == 17);
        CPPUNIT_ASSERT_MESSAGE("Expected the CMR cache space to be 20", NgapRequestHandler::d_cmr_cache_space == 7);
        CPPUNIT_ASSERT_MESSAGE("Expected the DMR++ cache space to be 20", NgapRequestHandler::d_dmrpp_cache_space == 7);
    }
