...
#ifndef BuildDmrppContainerStorage_h_
#define BuildDmrppContainerStorage_h_ 1
 ...
 */
class BuildDmrppContainerStorage: public BESContainerStorageVolatile {
public:
    BuildDmrppContainerStorage(const std::string &n);
    virtual ~BuildDmrppContainerStorage();
...
#endif // BuildDmrppContainerStorage_h_
