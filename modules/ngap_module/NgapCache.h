...
#ifndef MODULES_NGAP_MODULE_NGAPCACHE_H_
#define MODULES_NGAP_MODULE_NGAPCACHE_H_
...
/**
 * @brief A cache for content accessed via the NGAP.
 *
 ...
 * - _NGAP.Cache.dir_: The directory where retrieved data files should be stored
 * - _NGAP.Cache.prefix_: The item-name prefix for this cache
 * - _NGAP.Cache.size_: The size of the cache. Limit the total amount of
...
#endif /* MODULES_NGAP_MODULE_NGAPCACHE_H_ */
