...
#ifndef I_NgapPathInfoResponseHandler_h
#define I_NgapPathInfoResponseHandler_h 1
 ...
 * @see BESTransmitter
 */
class NgapPathInfoResponseHandler: public BESResponseHandler {
private:
    BESInfo *_response;
...
public:
    NgapPathInfoResponseHandler(const std::string &name);
    virtual ~NgapPathInfoResponseHandler(void);
    ...
    static BESResponseHandler *NgapPathInfoResponseBuilder(const std::string &name);
};

#endif // I_NgapPathInfoResponseHandler_h
