...
#include "BuildDmrppContainerStorage.h"
 ...
 */
    BuildDmrppContainerStorage::BuildDmrppContainerStorage(const string &n) :
            BESContainerStorageVolatile(n)
    {
    }

    BuildDmrppContainerStorage::~BuildDmrppContainerStorage()
    {
    }
 ...
 */
    void BuildDmrppContainerStorage::add_container(const string &s_name, const string &r_name, const string &type)
    {
        BESContainer *c = new BuildDmrppContainer(s_name, r_name, type);
 ...
 */
    void BuildDmrppContainerStorage::dump(ostream &strm) const
    {
        strm << BESIndent::LMarg << "BuildDmrppContainerStorage::dump - (" << (void *) this << ")" << endl;
        BESIndent::Indent();
