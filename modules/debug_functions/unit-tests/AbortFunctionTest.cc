...
class AbortFunctionTest: public CppUnit::TestFixture {
private:
    BaseTypeFactory btf;
    DDS *testDDS;
...
CPPUNIT_TEST_SUITE( AbortFunctionTest );
...
CPPUNIT_TEST_SUITE_REGISTRATION(AbortFunctionTest);
...
int main(int argc, char*argv[])
{
    ...
    while ((option_char = getopt(argc, argv, "dh")) != -1)
        ...
        case 'h': {     // help - show test names
            ...
            unsigned int prefix_len = libdap::AbortFunctionTest::suite()->getName().append("::").size();
