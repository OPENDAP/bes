...
{
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("NCMLRequestHandler::ncml_build_das", dhi.data[REQUEST_ID]);
...
bool NCMLRequestHandler::ncml_build_dds(BESDataHandlerInterface &dhi)
{
    ...
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("NCMLRequestHandler::ncml_build_dds", dhi.data[REQUEST_ID]);
...
{
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("NCMLRequestHandler::ncml_build_data", dhi.data[REQUEST_ID]);
...
{
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("NCMLRequestHandler::ncml_build_dmr", dhi.data[REQUEST_ID]);
