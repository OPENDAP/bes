...
#
# Usage: AT_BESCMD_H4_BESCONF2_RESPONSE_TEST([<bescmd file>], [<bes.conf>], [pass|xfail], [repeat|cached])
# The last two params are optional.
m4_define([AT_BESCMD_H4_BESCONF2_RESPONSE_TEST], [dnl
...
m4_define([AT_BESCMD_H4_BESCONF_RESPONSE_TEST], [dnl
...
m4_define([AT_BESCMD_H4_BESCONF_DAP2DATA_TEST], [
    AT_SETUP([$1 $2])
...
m4_define([AT_BESCMD_H4_BESCONF_NC_DAP4DATA_TEST], [
