...
#ifndef NDEBUG
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("W10nJsonTransmitter::send_data", dhi.data[REQUEST_ID]);
#endif
...
#ifndef NDEBUG
    BESStopWatch sw;
    if (BESISDEBUG(TIMING_LOG_KEY)) sw.start("W10nJsonTransmitter::send_metadata", dhi.data[REQUEST_ID]);
#endif
