...
void build_global_attributes(const GDALDatasetH& hDS, AttrTable* attr_table)
{
    /* -------------------------------------------------------------------- */
    /*      Geotransform                                                    */
    /* -------------------------------------------------------------------- */
...
void build_variable_attributes(const GDALDatasetH& hDS, AttrTable* band_attr, const int iBand)
{
    /* -------------------------------------------------------------------- */
    /*      Offset.                                                         */
    /* -------------------------------------------------------------------- */
