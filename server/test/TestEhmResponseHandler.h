 ...
 * are to be used to build the OPeNDAP TestEhm response object. It then
...
public:
				TestEhmResponseHandler( const string &name ) ;
    ...
    static BESResponseHandler *TestEhmResponseBuilder( const string &name ) ;
};
