...
%configure --disable-dependency-tracking --disable-static --with-hdf4-include=/usr/include/hdf --with-hdf4-libdir=/usr/lib64/hdf --with-hdfeos2=/root/hdfeos/hdfeos2 --enable-short-name
make %{?_smp_mflags}
