 ...
 */
DODSResponseHandler *
OPeNDAPSetContainerCommand::parse_request( OPeNDAPTokenizer &tokenizer,
                                           DODSDataHandlerInterface &dhi )
{
	...
	DODSResponseHandlerList::TheList()->find_handler( SETCONTAINER ) ;
    if( !retResponse )
    {
	throw OPeNDAPParserException( (string)"Improper command " + SETCONTAINER );
    }
