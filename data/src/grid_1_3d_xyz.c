/*
  ...
  %h4cc -I/path/to/hdfeos/include  -L/path/to/hdfeos/lib -o grid_1_3d_xyz \
        -lhdfeos -lgctp grid_1_3d_xyz.c
...
intn write_field_3d(int32 gdid, char* field_name)
{
    ...
    status = GDwritefield(gdid, "pressure", NULL, NULL, NULL, temp3);
    if(status == -1){
...
{
    intn status = 0;
    char filename[]= "grid_1_3d_xyz.hdf";
