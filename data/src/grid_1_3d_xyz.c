/*
  ...
  3d variable and 1d lat/lon/lev.
  
  Compilation instruction:

  %h5cc -I/path/to/hdfeos5/include  -L/path/to/hdfeos5/lib -o grid_1_3d_xyz \
        -lhe5_hdfeos -lGctp grid_1_3d_xyz.c
...
int main()
{
    ...
    hid_t  gdfid = FAIL;
    /* Create a file. */
    gdfid = HE5_GDopen("grid_1_3d_xyz.h5", H5F_ACC_TRUNC);
