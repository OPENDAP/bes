/*
  ...
  %h5cc -I/path/to/hdfeos5/include -L/path/to/hdfeos5/lib -o grid_2_2d_xy.c \
        -lhe5_hdfeos -lgctp
...
herr_t write_grid(hid_t gdfid, char* gname, int xy_flag);
...
int main()
{
    ...
    /* Create a file. */
    gdfid = HE5_GDopen("grid_2_2d_xy.h5", H5F_ACC_TRUNC);

    /* Write two identical grids except names. */
    write_grid(gdfid, "GeoGrid1", 0);
    write_grid(gdfid, "GeoGrid2", 1);
