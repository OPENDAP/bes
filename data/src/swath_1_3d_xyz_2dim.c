/*
  ...
  %h4cc -I/path/to/hdfeos/include  -L/path/to/hdfeos/lib -o swath_1_3d_xyz_2dim.c -lhdfeos -lgctp swath_1_3d_xyz_2dim
...
intn
write_field_3d(int32 swid, char *field_name, char *dim_name);
...
intn write_swath(int32 swfid, char* sname)
{
    ...
    char field_dim_name[]= "ZDim,ZDim,NDim";
    ...
    write_field_1d(swid, geo_name_lat, 1, 8, "NDim");
    write_field_1d(swid, geo_name_lon, 1, 8, "NDim");

    /* Write field. */
    write_field_3d(swid, field_name, field_dim_name);
...
{
    intn status = 0;
    char filename[]= "swath_1_3d_xyz_2dim.hdf";
