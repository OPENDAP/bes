/*
  Test 1 grid with 2 z variables: pressure[ZDim], level[ZDim]. 
  Temperature[ZDim][YDim][XDim]. 
 
  Compilation instruction:

  %h5cc -I/path/to/hdfeos5/include  -L/path/to/hdfeos5/lib -o grid_1_3d_zz \
        -lhe5_hdfeos -lGctp grid_1_3d_zz.c

  To generate the test file, run
  %./grid_1_3d_zz

  To view the test file, run
  %/path/to/hdf5/bin/h5dump grid_1_3d_zz.h5
...
herr_t write_grid(hid_t gdfid, char* gname)
{
    ...
    write_field_1d(gdid, "Pressure", "ZDim", 2, "hPa");
    write_field_1d(gdid, "Level", "ZDim", 2, "hPa");
