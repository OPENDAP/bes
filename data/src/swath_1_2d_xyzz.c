/*
  ...
  %h4cc -I/path/to/hdfeos/include  -L/path/to/hdfeos/lib -o swath_1_2d_xyzz \
        -lhdfeos -lgctp swath_1_2d_xyzz.c
...
intn write_swath(int32 swfid, char* sname)
{
    ...
    write_field_1d(swid, geo_name2, 1, 4, geo_dim_name);
...
{
    intn status = 0;
    char filename[]= "swath_1_2d_xyzz.hdf";
