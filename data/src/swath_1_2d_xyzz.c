/*
  Test a swath with 2d temperature[zdim][ndim], level[zdim], pressure[zdim], 
  lat[ndim], lon[ndim].
  ...
  %h5cc -I/path/to/hdfeos5/include  -L/path/to/hdfeos5/lib \
        -o swath_1_2d_xyzz swath_1_2d_xyzz.c \
        -lhe5_hdfeos -lGctp
  ...
  %/path/to/hdf5/bin/h5dump swath_1_2d_xyzz.h5
...
herr_t write_swath(hid_t swfid, char* sname)
{
    ...
    write_field_1d(swid, "Level",     1, 4, "ZDim", "hPa");
...
int main()
{
    ...
    /* Create a file. */
    swfid = HE5_SWopen("swath_1_2d_xyzz.h5", H5F_ACC_TRUNC);
