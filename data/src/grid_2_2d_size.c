/*
  ...
  %h4cc -I/path/to/hdfeos/include  -L/path/to/hdfeos/lib -o grid_2_2d_size \
        -lhdfeos -lgctp grid_2_2d_size.c
...
intn  write_grid(int32 gdfid, char* gname, int xdiim, int ydim);
...
{
    intn status = 0;
    char filename[]= "grid_2_2d_size.hdf";
