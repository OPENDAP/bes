/*
  ...
  %h4cc -I/path/to/hdfeos/include  -L/path/to/hdfeos/lib -o swath_1_3d_2x2yztd.c \ -lhdfeos -lgctp swath_1_3d_2x2yztd.c
...
intn write_swath(int32 swfid, char* sname)
{
    ...
    write_field_1d(swid, geo_name3, 1, 2, geo_dim_name3);
...
{
    intn status = 0;
    char filename[]= "swath_1_3d_2x2yztd.hdf";
