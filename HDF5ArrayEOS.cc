...
void
HDF5ArrayEOS::set_memneed(size_t need)
{
  d_memneed = need;
}

void
HDF5ArrayEOS::set_numdim(int ndims)
{
  d_num_dim = ndims;
}

void
HDF5ArrayEOS::set_numelm(int nelms)
{
  d_num_elm = nelms;
}
...
dods_float32*
HDF5ArrayEOS::get_dimension_data(dods_float32* buf,
