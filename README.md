...
README for the OpenDAP BES ![Travis-CI](https://travis-ci.org/OPENDAP/bes.svg?branch=master)
...
Note see [http://docs.opendap.org/index.php/Hyrax](http://docs.opendap.org/index.php/Hyrax)
...
_<prefix>/etc/bes/bes.conf_. Module and handler configuration files will
be installed in the _<prefix>/etc/bes/modules_ directory.
