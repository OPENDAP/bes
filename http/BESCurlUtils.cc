...
static size_t writeToOpenfileDescriptor(char *data, size_t /* size */, size_t nmemb, void *userdata) {
    ...
    BESDEBUG(MODULE,
             "BESCurlUtils::writeToOpenfileDescriptor() - Bytes received " << libdap::long_to_string(nmemb) << endl);
...
// #ifdef CURLOPT_PROXYAUTH
        ...
        BESDEBUG(MODULE, "BESCurlUtils::configureProxy() - Using CURLOPT_PROXYAUTH = " << proxyAuthType << endl);
            ...
            BESDEBUG(MODULE,
                     "BESCurlUtils::configureProxy() - Using CURLOPT_PROXYAUTH = " << getCurlAuthTypeName(proxyAuthType)
                                                                                   << endl);
