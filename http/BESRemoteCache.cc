...
const string BESRemoteCache::DIR_KEY = "HttpResourceCache.dir";
const string BESRemoteCache::PREFIX_KEY = "HttpResourceCache.prefix";
const string BESRemoteCache::SIZE_KEY = "HttpResourceCache.size";
