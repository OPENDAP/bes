...
#ifndef I_BESDelDefResponseHandler_h
#define I_BESDelDefResponseHandler_h 1
...
{
public:
				BESDelDefResponseHandler( string name ) ;
    ...
    static BESResponseHandler *DelDefResponseBuilder( string handler_name ) ;
};
