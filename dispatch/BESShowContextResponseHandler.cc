...
BESShowContextResponseHandler::BESShowContextResponseHandler( string name )
 ...
 */
void
BESShowContextResponseHandler::execute( BESDataHandlerInterface &dhi )
{
    dhi.action_name = SET_CONTEXT_STR ;
    BESInfo *info = BESInfoList::TheList()->build_info() ;
    _response = info ;

    info->begin_response( SHOW_CONTEXT_STR ) ;
 ...
 */
void
BESShowContextResponseHandler::dump( ostream &strm ) const
{
    strm << BESIndent::LMarg << "BESShowContextResponseHandler::dump - ("
			     << (void *)this << ")" << endl ;
    BESIndent::Indent() ;
...
BESResponseHandler *
BESShowContextResponseHandler::ShowContextResponseBuilder( string handler_name )
{
    return new BESShowContextResponseHandler( handler_name ) ;
}
