...
#ifndef DODSContainer_h_
#define DODSContainer_h_ 1
...
public:
     ...
     */
    			DODSContainer( const string &s ) ;
    /** @brief make a copy of the container
     *
     * @param copy_from The container to copy
     */
			DODSContainer( const DODSContainer &copy_from ) ;
...
#endif // DODSContainer_h_

// $Log: DODSContainer.h,v $
// Revision 1.5  2005/04/19 17:57:58  pwest
