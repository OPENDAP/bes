 ...
 */
void
BESShowContainersResponseHandler::dump( ostream &strm ) const
{
    strm << BESIndent::LMarg << "BESShowContainersResponseHandler::dump - ("
			     << (void *)this << ")" << endl ;
    BESIndent::Indent() ;
...
BESResponseHandler *
BESShowContainersResponseHandler::ShowContainersResponseBuilder( const string &name )
{
