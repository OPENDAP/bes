 ...
 */
BESBasicException::BESBasicException()
{
}
 ...
 */
BESBasicException::BESBasicException( const string &s )
{
    _description = s ;
}
 ...
 */
void
BESBasicException::set_error_description( const string &s )
{
    _description = s ;
}
 ...
 */
string
BESBasicException::get_error_description()
{
    return _description ;
}

// $Log: BESBasicException.cc,v $
