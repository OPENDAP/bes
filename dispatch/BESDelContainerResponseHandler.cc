 ...
 */
void
BESDelContainerResponseHandler::dump( ostream &strm ) const
{
    strm << BESIndent::LMarg << "BESDelContainerResponseHandler::dump - ("
			     << (void *)this << ")" << endl ;
    BESIndent::Indent() ;
...
BESResponseHandler *
BESDelContainerResponseHandler::DelContainerResponseBuilder( string handler_name )
{
    return new BESDelContainerResponseHandler( handler_name ) ;
}
