...
//#define DODS_MYSQL_BAD_QUERY 5 - no longer used
//#define DODS_PARSER_ERROR 6 - no longer used
...
#define DODS_AGGREGATION_EXCEPTION 11
#define OPeNDAP_FAILED_TO_EXECUTE_COMMIT_COMMAND 12
