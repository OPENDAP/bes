...
#ifndef BESContainerStorageException_h_
#define BESContainerStorageException_h_ 1
 ...
 * symbolic name
 */
class BESContainerStorageException:public BESBasicException
{
public:
...
// $Log: BESContainerStorageException.h,v $
