...
BESSetContextResponseHandler::BESSetContextResponseHandler( string name )
...
BESResponseHandler *
BESSetContextResponseHandler::SetContextResponseBuilder( string handler_name )
{
    return new BESSetContextResponseHandler( handler_name ) ;
}
