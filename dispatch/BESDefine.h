...
public:
    ...
    void set_agg_cmd(const std::string &cmd) { _agg_cmd = cmd; }

    const std::string &get_agg_cmd() { return _agg_cmd; }

    void set_agg_handler(const std::string &handler) { _agg_handler = handler; }

    const std::string &get_agg_handler() { return _agg_handler; }
