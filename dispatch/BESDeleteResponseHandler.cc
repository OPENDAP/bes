...
#include "BESDeleteResponseHandler.h"
#include "BESInfo.h"
...
BESDeleteResponseHandler::BESDeleteResponseHandler( string name )
    : BESResponseHandler( name )
{
}

BESDeleteResponseHandler::~BESDeleteResponseHandler( )
{
}
 ...
 */
void
BESDeleteResponseHandler::execute( BESDataHandlerInterface &dhi )
{
 ...
 */
void
BESDeleteResponseHandler::transmit( BESTransmitter *transmitter,
...
BESResponseHandler *
BESDeleteResponseHandler::DeleteResponseBuilder( string handler_name )
{
    return new BESDeleteResponseHandler( handler_name ) ;
}
