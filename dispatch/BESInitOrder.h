...
#ifndef D_BESInitOrder_h
#define D_BESInitOrder_h 1

#define BESKEYS_INIT 1
#define BESLOG_INIT 2

#define PERSISTENCELIST_INIT 1
#define REQUESTHANDLERLIST_INIT 1
#define RESPONSEHANDLERLIST_INIT 1
#define BESRETURNMANAGER_INIT 1
...
#define THEBESAUTHENTICATOR_INIT 3

#define BESMODULE_INIT 3

#endif // E_BESInitOrder_h

// $Log: BESInitOrder.h,v $
